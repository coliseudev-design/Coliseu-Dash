...
run_query(
    "COUNT OF ITEMS WITH NON-NULL CFOP",
    "SELECT COUNT(*) FROM dash_vendas_itens WHERE cfop IS NOT NULL"
)

run_query(
    "CHECK IF ANY VENDAS_ITENS HAVE cfop",
    "SELECT DISTINCT cfop FROM dash_vendas_itens LIMIT 10"
)
