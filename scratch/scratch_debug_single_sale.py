...
print("=== DEVOLUCOES IN JUNE 2026 ===")
sql = f"""
SELECT 
    COUNT(*),
    SUM(valor_total) as sum_header_total,
    SUM(COALESCE(valor_desconto, 0)) as sum_header_desconto
FROM dash_vendas 
...
print("=== SALES IN JUNE 2026 (Positive only) ===")
sql = f"""
SELECT 
    COUNT(*),
    SUM(valor_total) as sum_header_total,
