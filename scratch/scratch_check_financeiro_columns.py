...
print("=== COLUMNS OF dash_financeiro ===")
print(run_query("coliseu_dashboard", "SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'dash_financeiro'"))
