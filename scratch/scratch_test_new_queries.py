...
print(run_query("coliseu_dashboard", "ANALYZE dash_vendas; ANALYZE dash_vendas_itens; ANALYZE dash_produtos;"))

print("=== EXPLAIN ANALYZE OF MARCAS RANKING QUERY AFTER ANALYZE ===")
sql = f"""
EXPLAIN ANALYZE
