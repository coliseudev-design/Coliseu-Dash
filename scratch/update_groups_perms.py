...
print("--- ATUALIZANDO PERMISSÕES DO GRUPO ADMINISTRADOR NO BANCO ---")
run_query("""
    UPDATE dash_permissoes 
    SET pode_acessar = true 
    WHERE grupo_id IN (SELECT id FROM dash_grupos_acesso WHERE nome = 'Administrador')
""")

print("--- VERIFICANDO APÓS ATUALIZAÇÃO ---")
run_query("""
