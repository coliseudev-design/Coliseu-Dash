...
def run_middleware_node_code(label, node_code):
    ...
    cmd = f'docker exec {MW_CONTAINER} node -e "{node_code_escaped}"'
...
# We want to test /estatisticas/overview for tenant 'a822a7e7-fdd4-4483-bbb5-26587a72739f' in vet context.
...
const period = 'thisMonth'; // matching Month selection in UI
...
run_middleware_node_code("TESTING OVERVIEW QUERIES", node_test_script)
