...
const TABELAS_MAP = {
    ...
    'dash_vendas_itens': ['id_firebird', 'venda_id_firebird', 'produto_id_firebird', 'quantidade', 'preco_unitario', 'custo_unitario', 'valor_total', 'desconto_item', 'vendedor', 'produto', 'marca', 'categoria', 'depto_id'],
