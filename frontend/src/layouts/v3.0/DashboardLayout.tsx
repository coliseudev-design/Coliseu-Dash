...
const ROUTE_CONFIGS: Record<string, { label: string; icon: React.ElementType; color: string }> = {
  ...
  '/hub-vendedor': { label: 'Central do Vendedor', icon: Trophy, color: '#F97316' },
  ...
  '/bi/hub': { label: 'Inteligência de Vendas', icon: ShoppingCart, color: '#F97316' },
  '/bi/supplier': { label: 'Central do Fornecedor', icon: Truck, color: '#F59E0B' },
  '/bi/abc': { label: 'Inteligência de Estoque', icon: Package, color: '#06B6D4' },
  '/bi/finance': { label: 'Gestão Financeira', icon: Wallet, color: '#22C55E' },
  '/bi/customer': { label: 'Perfil 360° do Cliente', icon: Users, color: '#EC4899' },
  '/bi/comparative': { label: 'Análise de Lucratividade', icon: DollarSign, color: '#84CC16' },
  '/bi/customer-analytics': { label: 'Painel de Clientes', icon: Users, color: '#14B8A6' },
