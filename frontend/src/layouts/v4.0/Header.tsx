  ...
  return (
    <header className="h-14 sm:h-16 bg-white/80 backdrop-blur-md border-b border-[#E0E0E0]/50 sticky top-0 z-20 flex items-center px-3 sm:px-4 lg:px-6 transition-all duration-300">
      ...
      <div className="ml-auto flex items-center gap-1 sm:gap-3">
        ...
        {/* Layout Version */}
        <div className="hidden sm:flex items-center px-1.5 h-5 rounded-md border border-divider bg-bg-tertiary/30 text-[10px] font-mono text-text-muted cursor-default" title="Versão do Layout Ativo (Vet)">
          {user?.layout_version || 'v4.0'}
        </div>
