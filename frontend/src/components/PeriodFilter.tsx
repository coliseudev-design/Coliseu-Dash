...
export default function PeriodFilter() {
  ...
  return (
    <div className="mb-2 sm:mb-4 w-full sm:w-auto sm:inline-block max-w-full min-w-0 sm:bg-white sm:rounded-xl sm:border sm:border-gray-200 sm:shadow-sm sm:p-2 sm:px-3">
      <div 
